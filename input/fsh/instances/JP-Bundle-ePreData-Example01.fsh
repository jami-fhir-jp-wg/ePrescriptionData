...
* entry[+].fullUrl = "urn:uuid:1e9e5b25-5c46-5f42-9234-0e8406fcba2b"
* entry[=].resource = JP-Organization-ePreData-issuer-Example
...
* entry[=].resource = JP-Practitioner-ePreData-author-Example
