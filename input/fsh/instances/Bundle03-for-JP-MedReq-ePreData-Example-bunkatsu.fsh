...
InstanceOf: Bundle
Usage: #inline
Description: "分割処方Bundleリソースの３回目処方のインスタンス例（resource.event.period.startが９月４日から１週間分）"
...
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-1"
...
* entry[=].resource.author[0].reference = "urn:uuid:73f5fad9-530c-40b1-856f-c5a46fbad8cd"
* entry[=].resource.author[=].display = "処方作成者PractitionerRoleリソース"
* entry[=].resource.author[+].reference = "urn:uuid:9f1993bc-753f-479e-9e01-f0a53929a6fc"
...
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-2"
...
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-3"
...
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-4"
...
* entry[=].resource.resourceType = "Coverage"
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-5"
...
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-6"
...
* entry[=].resource.resourceType = "Organization"
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-7"
* entry[=].resource.meta.profile = "http://jpfhir.jp/fhir/ePrescription/StructureDefinition/JP_Organization_ePrescriptionData_coveragePayer"
...
* entry[=].resource.resourceType = "Organization"
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-8"
...
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-10"
...
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-11"
...
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-12"
...
* entry[=].resource.resourceType = "MedicationRequest"
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-13"
* entry[=].resource.meta.profile = "http://jpfhir.jp/fhir/ePrescription/StructureDefinition/JP_MedicationRequest_ePrescriptionData"
* entry[=].resource.identifier[0].system = "urn:oid:1.2.392.100495.20.3.81"
...
* entry[=].resource.id = "Inline-Instance-for-JP-Bundle03-ePreData-Example03-14"
