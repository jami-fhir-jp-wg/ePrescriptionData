Instance: Inline-Instance-for-JP-MedReq-ePreData-Example-bunkatsu-4
InstanceOf: Bundle
Usage: #inline
...
* entry[=].resource.author[0].reference = "urn:uuid:9b244427-7479-406f-a366-ee083526c74d"
* entry[=].resource.author[=].display = "処方作成者PractitionerRoleリソース"
* entry[=].resource.author[+].reference = "urn:uuid:73f5fad9-530c-40b1-856f-c5a46fbad8cd"
