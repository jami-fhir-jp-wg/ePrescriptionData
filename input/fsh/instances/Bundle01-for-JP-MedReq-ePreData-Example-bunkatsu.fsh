...
* entry[=].resource.subject.reference = "Patient-for-JP-MedReq-ePreData-Example-bunkatsu"
* entry[=].resource.subject.display = "患者リソースPatient"
* entry[=].resource.encounter.reference = "Encounter-for-JP-MedReq-ePreData-Example-bunkatsu"
...
* entry[=].resource.custodian.reference = "OrgIssuer-for-JP-MedReq-ePreData-Example-bunkatsu"
...
* entry[=].resource.section.entry[0].reference = "JP-Coverage-ePreData-insurance-Example"
* entry[=].resource.section.entry[=].display = "健康保険Coverage"
* entry[=].resource.section.entry[+].reference = "JP-Organization-ePreData-coveragePayer-Example"
* entry[=].resource.section.entry[=].display = "健康保険者Organaization"
* entry[=].resource.section.entry[+].reference = "JP-Coverage-ePreData-publicPayment-Example"
* entry[=].resource.section.entry[=].display = "公費負担Coverage"
* entry[=].resource.section.entry[+].reference = "JP-Organization-ePreData-publicPayer-Example"
