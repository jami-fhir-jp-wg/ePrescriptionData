Profile: JP_Communication_ePrescriptionData
...
* category.coding.system = "http://jpfhir.jp/fhir/ePrescription/StructureDefinition/JP_Communication_CommunicationContent" (exactly)
