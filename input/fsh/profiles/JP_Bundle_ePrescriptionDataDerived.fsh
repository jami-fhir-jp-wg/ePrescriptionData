Profile: JP_Bundle_ePrescriptionDataDerived
Parent: JP_Bundle_CCLIX
Id: JP-Bundle-ePrescriptionDataDerived
...
* ^url = "http://jpfhir.jp/fhir/ePrescription/StructureDefinition/JP_Bundle_ePrescriptionDataDerived"
* ^status = #draft
