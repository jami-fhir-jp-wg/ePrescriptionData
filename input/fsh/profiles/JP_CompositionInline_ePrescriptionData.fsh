...
Profile: JP_CompositionInline_ePrescriptionData
Parent: Composition
Id: JP-CompositionInline-ePrescriptionData
...
* ^url = "http://jpfhir.jp/fhir/ePrescription/StructureDefinition/JP_CompositionInline_ePrescriptionData"
* ^status = #draft
