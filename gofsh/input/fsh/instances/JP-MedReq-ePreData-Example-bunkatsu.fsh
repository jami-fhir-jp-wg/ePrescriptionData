...
* entry[=].resource = Inline-Instance-for-JP-MedReq-ePreData-Example-bunkatsu-1
* entry[+].fullUrl = "urn:uuid:9495ef34-a77d-4f3e-8dce-5688e169d0fa"
* entry[=].resource = Inline-Instance-for-JP-MedReq-ePreData-Example-bunkatsu-2
* entry[+].fullUrl = "urn:uuid:b0025d4d-3002-4f5e-fb4e-abead28aee35"
* entry[=].resource = Inline-Instance-for-JP-MedReq-ePreData-Example-bunkatsu-3
* entry[+].fullUrl = "urn:uuid:df8b4e6a-5d45-f4ce-a1af-ff0ca94242b8"
* entry[=].resource = Inline-Instance-for-JP-MedReq-ePreData-Example-bunkatsu-4
* entry[+].fullUrl = "urn:uuid:ef7892cc-fb3a-b951-9ac7-f8cd6c746f0a"
* entry[=].resource = Inline-Instance-for-JP-MedReq-ePreData-Example-bunkatsu-5
* entry[+].fullUrl = "urn:uuid:461cad23-e9a8-027e-d344-a52d957a64c0"
* entry[=].resource = Inline-Instance-for-JP-MedReq-ePreData-Example-bunkatsu-6
* entry[+].fullUrl = "urn:uuid:d1a238ee-5050-c23b-a930-307e12ee51ed"
* entry[=].resource = Inline-Instance-for-JP-MedReq-ePreData-Example-bunkatsu-7
* entry[+].fullUrl = "urn:uuid:37eab6c7-473a-aed1-3297-766839896d47"
* entry[=].resource = Inline-Instance-for-JP-MedReq-ePreData-Example-bunkatsu-8
* entry[+].fullUrl = "urn:uuid:07a43eb6-71d3-816a-0767-45a2a9b39899"
* entry[=].resource = Inline-Instance-for-JP-MedReq-ePreData-Example-bunkatsu-9
* signature.type = urn:iso-astm:E1762-95:2013#1.2.840.10065.1.12.1.1 "作成者の署名"
* signature.when = "2021-02-01T13:28:18.345+09:00"
* signature.who = Reference(urn:uuid:9b244427-7479-406f-a366-ee083526c74d)
