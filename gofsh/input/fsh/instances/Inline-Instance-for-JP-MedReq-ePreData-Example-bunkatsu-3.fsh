...
* entry[=].resource.author[0].reference = "urn:uuid:0a093ac3-084e-d4b1-271f-d0000b092971"
* entry[=].resource.author[=].display = "処方作成者PractitionerRoleリソース"
* entry[=].resource.author[+].reference = "urn:uuid:5c96291d-5d8c-02c1-e5a5-1cee31ad1bf4"
